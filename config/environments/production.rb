Rails.application.configure do
  ...
  config.action_controller.asset_host = 'cdn.dev-start.net.w.kunlunAr.com'
  ...
  config.action_mailer.default_url_options = { :host => Settings.home_url }
